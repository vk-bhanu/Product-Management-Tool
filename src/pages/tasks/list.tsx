...
const List = ({ children }: React.PropsWithChildren) => {
  ...
  const { data: stages, isLoading: isLoadingTasks } = useList<TaskStage>({
    resource: 'tasks',
    sorters: [
      {
        field: 'dueDate',
  ...
  const { data: tasks, isLoading: isLoadingStages } = useList<GetFieldsFromList<TasksQuery>>({
    resource: 'taskStages',
    filters: [
      {
        field: 'title',
